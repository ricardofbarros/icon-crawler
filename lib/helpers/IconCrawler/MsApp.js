...
IconCrawlerMsApp.prototype.parseBrowserConfig = function (str, callback) {
  ...
  return parseXml(str, function (err, elem) {
    ...
    var square150 = elem['square150x150logo'] ? elem['square150x150logo'] : false;
    square150 = square150 && util.isArray(square150) ? square150[0] : false;
    square150 = square150 && typeof square150 === 'object' ? square150 : false;
    square150 = square150 && square150.$ ? square150.$ : false;
    square150 = square150 && square150.src ? square150.src : false;
